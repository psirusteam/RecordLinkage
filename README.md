...
Este repositorio ya no necesita GitHub Actions para publicar el sitio. La idea es generar el sitio en su propia PC, subir los archivos resultantes al repositorio y hacer que GitHub Pages sirva directamente la carpeta principal (`/`). Desde la raíz del repositorio, ejecute:
